...
const DynamicEditIcon = dynamic(
  () => import("@chakra-ui/icons").then((mod) => mod.EditIcon),
  { ssr: false }
);

import { Order, OrderItem, Table } from "@/lib/config/entities";
            ...
            <VStack spacing={4} align="stretch">
              <Box>
                ...
                {currentOrder.items.map((item: OrderItem) => (
                  ...
                  >
                    <Text flex="3" color="var(--dark-gray-text)">
                      {item.name}
                    </Text>
                    <Text
                      flex="1"
