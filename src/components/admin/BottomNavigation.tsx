// src/components/admin/BottomNavigation.tsx
'use client';

import React from 'react';
import { Flex, Box, Icon, Text, Link } from '@chakra-ui/react';
import { FaTachometerAlt, FaBuilding, FaChartBar, FaCog } from 'react-icons/fa';
  ...
  return (
    ...
    >
      <Flex h="100%">
        ...
        <NavItem href="/admin/tenants" icon={FaBuilding} label="Tenants" />
        <NavItem href="/admin/reports" icon={FaChartBar} label="Reports" />
        <NavItem href="/admin/settings" icon={FaCog} label="Settings" />
      </Flex>
    </Box>
  );
}